...
function setMessage(text, isError = false) {
  ...
  adminMessage.classList.remove("is-success", "is-error");
  if (text) adminMessage.classList.add(isError ? "is-error" : "is-success");
}
  ...
  filteredLessons.forEach((lesson) => {
    ...
    row.innerHTML = `
      <div class="lesson-card-head">
        ...
        <label class="field-tag time-tag">
          시작
        ...
        <button type="button" class="icon-danger" data-action="remove" aria-label="이 수업 삭제">✕</button>
      </div>
